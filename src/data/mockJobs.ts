...
export const mockJobs: Job[] = [
  ...
  },
  {
    ...
    sourceId: "jobs_cz",
    sourceUrl: "https://www.jobs.cz/rpd/data-entry-clerk-prague",
  },
  {
    id: "12",
  ...
  // ===== Jobs.cz integration (Czech Republic) =====
  {
    id: "jobscz-1",
    ...
    type: "Full-time",
    description: "Join our security team and build tools used by hundreds of millions of users. Modern stack, mentoring program for juniors.",
    skills: ["Java", "Spring Boot", "Git", "SQL"],
    requiredSkills: ["Java", "SQL"],
    requiredLanguages: [{ language: "english", level: "B2" }, { language: "czech", level: "B1" }],
    experienceRequired: "1_year",
    applicants: 34,
    positions: 2,
    avgDaysToFill: 25,
    dimensions: { stress_level: 45, isolation_level: 30, physical_demand: 5, environment_type: "city", shift_type: "day", climate: "moderate", social_interaction: 60, routine_level: 35 },
    sourceId: "jobs_cz",
    sourceUrl: "https://www.jobs.cz/rpd/junior-java-developer-avast",
  },
  {
    id: "jobscz-2",
    ...
    type: "Full-time",
    description: "Lead online campaigns for the largest Czech e-commerce. Performance marketing, analytics, content strategy.",
    skills: ["Google Ads", "Analytics", "SEO", "Copywriting"],
    requiredLanguages: [{ language: "czech", level: "C1" }, { language: "english", level: "B2" }],
    experienceRequired: "2_years",
    applicants: 60,
    positions: 1,
    avgDaysToFill: 30,
    dimensions: { stress_level: 55, isolation_level: 25, physical_demand: 5, environment_type: "city", shift_type: "day", climate: "moderate", social_interaction: 70, routine_level: 40 },
    sourceId: "jobs_cz",
    sourceUrl: "https://www.jobs.cz/rpd/marketing-specialist-alza",
  },
  {
    id: "jobscz-3",
    title: "Customer Support (German speaking)",
    company: "Socialbakers",
    country: "Czech Republic",
    city: "Brno",
    salary: "€20,000 – €26,000",
    type: "Full-time",
    description: "Support German-speaking clients of our SaaS platform. Tickets, calls, light troubleshooting.",
    skills: ["Customer service", "German", "SaaS"],
    requiredLanguages: [{ language: "german", level: "C1" }, { language: "english", level: "B2" }],
    experienceRequired: "6_months",
    applicants: 18,
    positions: 3,
    avgDaysToFill: 18,
    dimensions: { stress_level: 40, isolation_level: 30, physical_demand: 5, environment_type: "city", shift_type: "day", climate: "moderate", social_interaction: 80, routine_level: 65 },
    sourceId: "jobs_cz",
    sourceUrl: "https://www.jobs.cz/rpd/customer-support-de-brno",
  },
  {
    id: "jobscz-4",
    title: "Skladník / Operátor výroby",
    company: "Škoda Auto a.s.",
    country: "Czech Republic",
    city: "Mladá Boleslav",
    salary: "€16,000 – €22,000",
    type: "Full-time",
    description: "Práce ve výrobě nebo skladu v automobilce. Třísměnný provoz, příspěvek na bydlení a stravování.",
    skills: ["Physical fitness", "Reliability", "Teamwork"],
    requiredLanguages: [{ language: "czech", level: "B1" }],
    experienceRequired: "no_experience",
    applicants: 9,
    positions: 15,
    avgDaysToFill: 7,
  ...
  },
  {
    id: "jobscz-5",
    title: "Účetní",
    company: "KPMG Česká republika",
    country: "Czech Republic",
    city: "Prague",
    salary: "€26,000 – €34,000",
    type: "Full-time",
    description: "Vedení účetnictví menších klientů, daňová přiznání, komunikace s úřady.",
    skills: ["Accounting", "Excel", "Tax"],
    requiredLanguages: [{ language: "czech", level: "C1" }, { language: "english", level: "B1" }],
    experienceRequired: "2_years",
    applicants: 25,
    positions: 1,
    avgDaysToFill: 22,
    dimensions: { stress_level: 55, isolation_level: 30, physical_demand: 5, environment_type: "city", shift_type: "day", climate: "moderate", social_interaction: 50, routine_level: 75 },
    sourceId: "jobs_cz",
    sourceUrl: "https://www.jobs.cz/rpd/ucetni-kpmg",
  },
];
